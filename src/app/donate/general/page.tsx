  ...
  return (
    <div className="min-h-screen bg-black relative overflow-hidden">
      ...
      <div className="relative z-10 text-center pt-16 pb-8">
        ...
        <h1 className="text-4xl font-bold text-white mb-4">General Donation</h1>
        <p className="text-amber-200 text-lg">Support the Waterbury Islamic Cultural Center</p>
      </div>
        ...
        <div className="bg-gradient-to-br from-slate-900 to-slate-800 rounded-2xl shadow-2xl p-8 border border-amber-400" style={{
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <div className="flex gap-4">
                <input
                  ...
                  className="flex-1 p-4 rounded-xl bg-slate-700 text-white placeholder-gray-400 border border-amber-400 focus:border-amber-300 focus:outline-none"
                />
                <button
                  type="button"
                  onClick={() => setDonationAmount(customAmount)}
                  className="px-6 py-4 bg-amber-600 text-white rounded-xl font-bold hover:bg-amber-700 transition-colors"
                >
                  Set
                </button>
              </div>
            ...
            <button
              ...
              className="w-full py-4 bg-gradient-to-r from-amber-600 to-amber-700 hover:from-amber-700 hover:to-amber-800 disabled:from-gray-600 disabled:to-gray-700 text-white font-bold text-xl rounded-xl transition-all duration-300 shadow-lg hover:shadow-xl disabled:cursor-not-allowed"
              style={{
                boxShadow: '0 0 20px rgba(245, 158, 11, 0.5), 0 0 40px rgba(245, 158, 11, 0.3)'
              }}
            >
              {isProcessing ? 'Processing Donation...' : `Donate $${donationAmount || customAmount || '0'}`}
            </button>
          </form>
        </div>
      </div>
