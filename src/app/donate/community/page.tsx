...
export default function CommunityDonation() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      alert('Thank you for your community donation! A tax receipt will be emailed to you.');
    }, 2000);
  };
  ...
  return (
    <div className="min-h-screen bg-black relative overflow-hidden">
      ...
      <div className="relative z-10 text-center pt-16 pb-8">
        ...
        <h1 className="text-4xl font-bold text-white mb-4">🤝 Community Fund</h1>
        <p className="text-amber-200 text-lg">Supporting Our Community Together</p>
      </div>

      {/* Community Impact */}
      <div className="relative z-10 max-w-4xl mx-auto px-6 mb-8">
        <div className="bg-gradient-to-br from-purple-900 to-purple-800 rounded-2xl shadow-2xl p-6 border border-purple-400" style={{
          boxShadow: '0 0 30px rgba(147, 51, 234, 0.3), 0 0 60px rgba(147, 51, 234, 0.1)'
        }}>
          <h3 className="text-2xl font-bold text-white mb-4 text-center">Your Community Donation Supports:</h3>
          <div className="grid md:grid-cols-3 gap-6">
            <div className="text-center">
              <div className="text-4xl mb-2">🍽️</div>
              <h4 className="text-lg font-semibold text-purple-200 mb-2">Community Events</h4>
              <p className="text-purple-100 text-sm">Iftar dinners, Eid celebrations, and community gatherings</p>
            </div>
            <div className="text-center">
              <div className="text-4xl mb-2">👥</div>
              <h4 className="text-lg font-semibold text-purple-200 mb-2">Social Services</h4>
              <p className="text-purple-100 text-sm">Supporting families in need and community outreach programs</p>
            </div>
            <div className="text-center">
              <div className="text-4xl mb-2">🏠</div>
              <h4 className="text-lg font-semibold text-purple-200 mb-2">Facility Maintenance</h4>
              <p className="text-purple-100 text-sm">Keeping our community center clean, safe, and welcoming</p>
            </div>
          </div>
        </div>
      </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="bg-gradient-to-br from-purple-900 to-purple-800 rounded-xl p-6 border-2 border-purple-500" style={{
              ...
              <p className="text-purple-100 text-sm leading-relaxed">
                <strong className="text-white">WICC is a registered 501(c)(3) non-profit organization.</strong> Your community donation is tax-deductible. 
            ...
            >
              {isProcessing ? 'Processing Donation...' : `Donate $${donationAmount || customAmount || '0'} to Community`}
            </button>
          </form>
        </div>
      </div>
